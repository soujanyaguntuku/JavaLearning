...
public class SavingsAccountThisKeyword {
  public String owner;
  public int balanceDollar;
  public double balanceEuro;

  public SavingsAccountThisKeyword(String owner, int balanceDollar){
  ...
  public static void main(String[] args){
    SavingsAccountThisKeyword zeusSavingsAccount = new SavingsAccountThisKeyword("Zeus", 1000);
